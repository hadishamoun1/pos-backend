import {
  ...
  export class ReceiptVoucherController {
    ...
    @Post()
    async createReceiptVoucher(@Body() data: Partial<ReceiptVoucher>): Promise<ReceiptVoucher> {
      try {
    ...
    @Get(':id')
    async getReceiptVoucherById(@Param('id') id: number): Promise<ReceiptVoucher> {
      try {
    ...
    async updateReceiptVoucher(
      @Param('id') id: number,
      @Body() data: Partial<ReceiptVoucher>,
