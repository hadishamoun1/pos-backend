...
export class Dimension {
  ...
  @OneToMany(() => PurchaseInvoiceItem, (purchaseItem) => purchaseItem.dimension)
  purchaseItems: PurchaseInvoiceItem[]; // Collection of purchase items referencing this dimension
}
