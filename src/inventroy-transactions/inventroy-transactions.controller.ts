...
export class InventoryTransactionController {
   ...
   */
  @Post()
  async createTransaction(@Body() body: { itemVariantId: number; transactionType: 'purchase' | 'sale'; sqm: number }): Promise<InventoryTransaction> {
    return this.inventoryTransactionService.createTransaction(body.itemVariantId, body.transactionType, body.sqm);
  }
   ...
   */
  @Get(':itemVariantId')
  async getTransactionsByItem(@Param('itemVariantId') itemVariantId: number): Promise<InventoryTransaction[]> {
